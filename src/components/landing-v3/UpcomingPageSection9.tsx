...
function Index() {
  ...
  // Transform scroll progress to orbit movement with multiple properties
  const orbitY = useTransform(
    scrollYProgress,
    [0, 1],
    [0, window.innerHeight * 0.7] // Reduced vertical movement
  );

  const orbitX = useTransform(
    scrollYProgress,
    [0, 1],
    [0, window.innerWidth * 0.4] // Add horizontal movement
  );
        ...
        <div className="min-h-screen w-screen overflow-hidden bg-[#0a0d1e]">
          ...
          <motion.div
            ...
            style={{
              ...
              position: 'fixed', // Make it fixed to maintain position during scroll
