    ...
    <div className="min-h-screen bg-[#0a0d1e] relative overflow-hidden flex items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="relative max-w-7xl w-full mx-auto">
        ...
        <div className="relative max-w-3xl mx-auto">
          <div className="flex items-center gap-4 sm:gap-6 max-w-4xl mx-auto">
            {/* Left Navigation */}
            <button
              onClick={handlePrev}
              className="hidden sm:flex items-center justify-center flex-shrink-0 w-12 h-12 rounded-full bg-[rgba(67,97,238,0.1)] backdrop-blur-lg border border-[rgba(67,97,238,0.2)] hover:bg-[rgba(67,97,238,0.2)] hover:border-[#4361ee] transition-all duration-300 hover:scale-110 group"
            >
            ...
            <div className="relative flex-1">
              ...
              <div className="flex sm:hidden justify-between items-center mt-6">
                <button
                  onClick={handlePrev}
                  className="p-3 rounded-full bg-[rgba(67,97,238,0.1)] backdrop-blur-lg border border-[rgba(67,97,238,0.2)] hover:bg-[rgba(67,97,238,0.2)] hover:border-[#4361ee] transition-all duration-300 group"
                >
                  <ChevronLeft className="w-5 h-5 text-white group-hover:text-[#4cc9f0] transition-colors" />
                </button>
                ...
                <button
                  ...
                  className="p-3 rounded-full bg-[rgba(67,97,238,0.1)] backdrop-blur-lg border border-[rgba(67,97,238,0.2)] hover:bg-[rgba(67,97,238,0.2)] hover:border-[#4361ee] transition-all duration-300 group"
                >
                  <ChevronRight className="w-5 h-5 text-white group-hover:text-[#4cc9f0] transition-colors" />
                </button>
              </div>
            </div>
