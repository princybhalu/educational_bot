...
const ChatInterface: React.FC = () => {
  ...
  //   const updateCursorPosition = (wordElement: HTMLSpanElement | null, letterIndex: number, word: string) => {
  ...
  const typeWord = async (word: string) => {
    ...
    for (let i = 0; i <= word.length; i++) {
      ...
      //     const currentWordSpan = textContainerRef.current.querySelector('.current-word') as HTMLSpanElement;
      //     if (currentWordSpan) {
      ...
      <div className="w-full max-w-3xl relative">
        ...
        >
          <p className="text-lg text-white leading-relaxed relative">
            ...
            style={{
              transition: 'transform 0.05s cubic-bezier(0.4, 0.0, 0.2, 1), height 0.05s ease',
              animation: 'cursorBlink 1s infinite cubic-bezier(0.68, -0.55, 0.27, 1.55)',
