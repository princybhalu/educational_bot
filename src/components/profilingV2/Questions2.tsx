...
const QuestionCard: React.FC<QuestionCardProps> = ({
  ...
  return (
    <div
      className={`mx-auto bg-gray-800 text-white rounded-lg p-6 shadow-lg w-full transition-all duration-500
...
const Quiz: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full max-w-4xl items-center justify-center perspective-container">
      <div className="w-full mx-auto flex flex-col items-center">
        <div
          className={`relative w-24 h-24 mb-4 ${isMinimized ? 'minimize-diagonal' : ''}`}
          style={{
