  ...
  return (
    ...
    100% {
      ...
      <div className="max-w-4xl w-full p-4 items-center">
        ...
        {/* Steps */}
        <div className="flex justify-between w-full items-center flex-wrap mb-4">
          <div className="flex flex-col items-center text-gray-300 mb-4 md:mb-0">
            <FaCog className="text-blue-400 text-3xl mb-2 rotate-cog" />
            <span>Configuring Preferences</span>
          </div>
          <div className="flex flex-col items-center text-gray-300 mb-4 md:mb-0">
            <FaBrain className="text-purple-400 text-3xl mb-2 pulse-brain" />
            <span>Training Neural Networks</span>
          </div>
          <div className="flex flex-col items-center text-gray-300 mb-4 md:mb-0">
            <FaBolt className="text-pink-500 text-3xl mb-2 flash-bolt" />
        ...
        {progressPercent === 100 && (
          <button
            ...
            className="mt-8 bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-6 rounded-lg transition-all duration-300"
          >
            Lets Visit Website
          </button>
        )}
