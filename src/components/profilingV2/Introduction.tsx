...
//   const aiMessage = "These questions aren't just to help us understand you better, they are key to how our AI will train teachers to support your learning style. Answering thoroughly will provide the most tailored guidance possible! ";
...
//     const particles = Array.from({ length: particleCount }, createDrainParticle);
...
//             <h1 className="text-xl md:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-400 to-pink-500 animate-gradient-x mb-2">
//               Let&rsquo;s create your perfect learning journey
//             </h1>
//             <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-24 h-1 bg-gradient-to-r from-blue-400 via-purple-400 to-pink-500 rounded-full" style={{
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="flex flex-row md:flex-col items-center mb-4 md:mb-6 space-x-2 md:space-x-0">
          <div className="flex items-center justify-center w-12 h-12 md:h-16 md:w-16 bg-blue-500/20 rounded-2xl p-2 md:p-4 group-hover:scale-110 transition-transform duration-300">
            <svg
              width="32"
              height="32"
              viewBox="0 0 24 24"
          ...
          <h3 className="text-lg md:text-2xl font-semibold text-blue-400 md:mt-4">
            {title}
          </h3>
        </div>
  ...
  return (
    <div className="w-full min-h-screen max-w-4xl p-4 md:p-8 flex flex-col justify-centermmt-4">
      ...
      <div className="text-center mb-6 md:mb-12">
        <h1 className="text-xl md:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-400 to-pink-500 animate-gradient-x mb-4">
            ...
            <div className="w-full max-w-3xl relative">
              <div className="flex flex-col items-center mb-16">
                ...
                <div className="text-center relative">
                  ...
                  <div
                    className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-24 h-1 bg-gradient-to-r from-blue-400 via-purple-400 to-pink-500 rounded-full"
                    style={{
                      animation: 'shimmer 2s infinite',
                    }}
                  />
              ...
              <div
                ref={textContainerRef}
                className="bg-gray-900 rounded-lg p-4 md:p-8 shadow-lg border border-gray-800 mb-6"
              >
              ...
              {isTypingComplete && (
                <div className="flex justify-center">
                  <button
                    ...
                    className="px-4 py-2 md:px-8 md:py-4 bg-gradient-to-r from-blue-400 via-purple-400 to-pink-500 rounded-lg text-white font-semibold text-md md:text-lg transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl relative overflow-hidden group"
                  >
                    <span className="relative z-10">Continue Your Journey</span>
                    <div className="absolute inset-0 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
